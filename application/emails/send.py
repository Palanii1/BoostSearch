...
def make_message(user, main_workbook):
    ...
    return {
        'name' : user.name,
        'standing' : standing,
        'email' : user.email if user.email else 'boostsearchnotifications@gmail.com',
        # FOR TESTING PURPOSES
        #'email': 'boostsearch@gmail.com',
...
def send_email(user_email, email_address, email_pwd, email_body, email_excel):
    ...
    msg['To'] = user_email
    msg['Subject'] = 'Your Weekly Job Boostsearch Report!'
...
def main():
    ...
    # Sets up the workbook for Boostsearch staff
    # Each sheet will contain the jobs summary page for each applicant
    ...
    main_workbook.close()
    send_email('applicant_no@boostsearch.com', email_address,
               email_pwd, '\n\n'.join(total_report), main_workbook_name)
    # FOR TESTING PURPOSES
    #send_email('boostsearchnotifications@gmail.com', email_address,
    #           email_pwd, '\n\n'.join(total_report), main_workbook_name)
